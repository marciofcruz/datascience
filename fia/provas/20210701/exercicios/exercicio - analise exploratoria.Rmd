...
summary(dados$V)
dados
vendas.min <- min(dados$V)
vendas.max <- max(dados$V)
vendas.mediana <- median(dados$V, na.rm = T)
vendas.q1 <- quantile(dados$V, 0.25)
vendas.q3 <- quantile(dados$V, 0.75)
