...
```{r echo = F}
# 
dfauxiliar <-subset(df_inadimplentes, select = c("Renda", "Volume_Financiamento", "Valor_Anual_Parcelas", "Populacao_Regiao", "Membros_Familia", "Filhos", "Rating_Regiao_Moradia"))
summary(dfauxiliar)
```
...
```{r echo = F}
# 
dfauxiliar <-subset(df_adimplentes, select = c("Renda", "Volume_Financiamento", "Valor_Anual_Parcelas", "Populacao_Regiao", "Membros_Familia", "Filhos", "Rating_Regiao_Moradia"))
summary(dfauxiliar)
```
