...
regressao.2 <- lm(data=startups, Lucro ~ Investimento_PeD )
summary(regressao.2)

regressao.3 <- lm(data=startups, Lucro ~ Investimento_em_Mkt )
summary(regressao.3)
...
#### 82,4% do aumento do lucoro é explicado pelas variáveis de investimento em Mkt e P&D pela Regressão Linear Múltipla.
...
y_estimado <- 44524.26405 + 0.06502*investimento_mkt + 0.74402*investimento_ped + 5654.55403*0
```
