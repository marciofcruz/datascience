...
**Interpretação:**  Os coeficientes estão no item "a". As variáveis de Salário e e Rendimento TOtal possuem multicolinearidade entre si. Assim, adotou-se a variável com a maior correlação que é salário.
...
summary(regressao4)
#summary(regressao4)$"adj.r.squared"

#regressao5 <- lm(data = dados_lim_cred, formula = LimitedoChequeEspecial ~  Salario + LimitedeCreditoImediato + Escolaridade )
#summary(regressao5)
#summary(regressao5)$"adj.r.squared"
```
...
y_estimado <- -2309.11531 + (0.46161 x salario) + (2395.81108 x regiao) + (3963.11176)

### f) Estime o valor do limite de cheque especial para um cliente que tem salário de R$4.850, de São Paulo e gênero masculino.
```{r}
x.salario <- 4850
y_estimado <- -2309.11531 + (0.46161 * x.salario) + (2395.81108) + (3963.11176)
